...
export function glideTheme(dark: boolean): Theme {
  ...
  return {
    ...
    lineHeight: 1.6,
    editorFontSize: "16px",
    headerFontStyle: "600 16px system-ui, -apple-system, sans-serif",
    baseFontStyle: "16px system-ui, -apple-system, sans-serif",
    markerFontStyle: "600 16px system-ui, -apple-system, sans-serif",
