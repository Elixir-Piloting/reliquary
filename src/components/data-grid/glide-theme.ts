...
export function glideTheme(dark: boolean): Theme {
  ...
  return {
    ...
    lineHeight: 1.5,
    editorFontSize: "14px",
    headerFontStyle: "600 13px system-ui, -apple-system, sans-serif",
    baseFontStyle: "14px system-ui, -apple-system, sans-serif",
    markerFontStyle: "600 13px system-ui, -apple-system, sans-serif",
