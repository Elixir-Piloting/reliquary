...
export function glideTheme(dark: boolean): Theme {
  ...
  return {
    ...
    lineHeight: 1.55,
    editorFontSize: "15px",
    headerFontStyle: "600 14px system-ui, -apple-system, sans-serif",
    baseFontStyle: "15px system-ui, -apple-system, sans-serif",
    markerFontStyle: "600 14px system-ui, -apple-system, sans-serif",
